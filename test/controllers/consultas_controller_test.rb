...
class ConsultasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create consulta" do
    assert_difference("Consulta.count") do
      post consultas_url, params: { consulta: { data: @consulta.data, medico_id: @consulta.medico_id, paciente_id: @consulta.paciente_id } }
    end
  ...
  test "should update consulta" do
    patch consulta_url(@consulta), params: { consulta: { data: @consulta.data, medico_id: @consulta.medico_id, paciente_id: @consulta.paciente_id } }
